...
export const environment = {
  ...
  clientSettings: {
    ...
    silent_redirect_uri: 'http://127.0.0.1:4000/silent-refresh.html',
    response_type: "code",
    scope:"design:content:read design:meta:read design:content:write design:permission:read design:permission:write comment:read comment:write brandtemplate:meta:read brandtemplate:content:read profile:read",
